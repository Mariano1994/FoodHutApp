    ...
    <>
      <footer>
        ...
        <div className='footer-foodhut__foodhut'>
          <h3>Foodhut</h3>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor, omnis accusantium enim assumenda.</p>
        ...
        <div className='footer-foodhut__links'>
            ...
            <div className='footer-foodhut__link get-in__touch'>
              ...
              <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laudantium nihil distinctio odit similique debitis.</p>
